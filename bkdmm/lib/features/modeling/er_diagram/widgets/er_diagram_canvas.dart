      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            // 模式切换
            TDButton(
              icon: editMode ? TDIcons.edit : TDIcons.move,
              size: TDButtonSize.small,
              type: TDButtonType.outline,
              theme: editMode ? TDButtonTheme.primary : TDButtonTheme.defaultTheme,
            ...
            Container(width: 1, height: 20, color: isDark ? Colors.grey.shade700 : Colors.grey.shade300),
